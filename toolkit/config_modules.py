...
class LoggingConfig:
    def __init__(self, **kwargs):
        ...
        self.resume_id: str = kwargs.get('resume_id', None)
...
class SampleConfig:
    def __init__(self, **kwargs):
        ...
        self.is_analogy = kwargs.get('is_analogy', False)
        self.is_box_analogy = kwargs.get('is_box_analogy', False)
...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        # debug options
        self.debug_save_target_images = kwargs.get('debug_save_target_images', False)
...
class DatasetConfig:
    ...
    def __init__(self, **kwargs):
        ...
        # if true, will use analogy method to process control images
        self.is_analogy: bool = kwargs.get('is_analogy', False)
        self.is_box_analogy: bool = kwargs.get('is_box_analogy', False)
        self.is_bidirectional_analogy: bool = kwargs.get('is_bidirectional_analogy', False)
        self.enable_relation_captions: bool = kwargs.get('enable_relation_captions', False)
...
class GenerateImageConfig:
    def __init__(
            ...
            fps: int = 15,
            ctrl_idx: int = 0,
            analogy_width: Optional[int] = None,
            analogy_height: Optional[int] = None,
            is_analogy: bool = False,
            is_box_analogy: bool = False,
    ):
        ...
        self.analogy_width = analogy_width
        self.analogy_height = analogy_height
        ...
        self.is_analogy = is_analogy
        if self.analogy_width is not None:
            self.analogy_width = max(64, self.analogy_width - self.analogy_width % 8)  # round to divisible by 8
        if self.analogy_height is not None:
            self.analogy_height = max(64, self.analogy_height - self.analogy_height % 8)  # round to divisible by 8

        # print("is_box_analogy", is_box_analogy)
        # exit(0)
        self.is_box_analogy = is_box_analogy
